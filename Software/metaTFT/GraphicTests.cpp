/**
* GraphicTests.cpp - a collection of test routines
*/

#include "GraphicTests.h"
#define TEST_TEXT       0
#define TEST_LINES      0
#define TEST_HVLINES    0
#define TEST_CIRCLES    0
#define TEST_RECTANGLES 1
#define TEST_ROUNDRECT  1
#define TEST_TRIANGLES  0

#define TEST_DELAY      800
...
unsigned long testText() {
  const ILI9341_t3_font_t* oldFont = tft.getFont();
  tft.setFontAdafruit();
  tft.fillScreen(ILI9341_BLACK);
  unsigned long start = micros();
  tft.setCursor(0, 0);
